"""Native cognis-connect emit for dealflow — forward findings to any platform.

Maps dealflow's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    dealflow ... --format json | dealflow-emit --to stix
    dealflow-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
